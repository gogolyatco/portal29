...
w4 = Wall(154, 205, 50, 200, 20, 10, 350)
...
background = transform.scale(image.load("room.portal.jpg"),(win_width, win_height))
player=Player("Chell.png",5,win_height-80,4)
monster=Enemy("turret.png",win_width-80,320,2)
final=GameSprite("Portal_Cake.png",win_width-120,400,0)
game=True
clock=time.Clock()
FPS=60
mixer.init()
mixer.music.load('Science_is_Fun.mp3')
mixer.music.play()
while game:
    for e in event.get():
        if e.type == QUIT:
